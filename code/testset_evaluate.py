...
def Evaluate(jsonpath, ResultAudioPath, gtAudioPath):
    ...
    # init progressbar
    bar = progressbar.ProgressBar(maxval=len(gt))
    bar.start()

    for idx, keys in enumerate(gt):
        bar.update(idx + 1)
...
if __name__ == '__main__':
    jsonpath = '../dataset/testset_result'
    ResultAudioPath = '../dataset/testset_result'
    gtAudioPath = '../dataset/testset_gt'
